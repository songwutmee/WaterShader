...
* **Intersection Foam Generation:** Instead of manually placing foam textures around objects, I developed a system that dynamically generates a crisp white outline wherever the water intersects with solid geometry like rocks or shorelines.
